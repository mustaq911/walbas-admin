    ...
    return (
        <div>
            <div className="flex gap-2 mb-2 justify-end">
                <AppModal
                    title='Link Course'
                    description='Link New Course'
                    button={<Button>
                        <Plus className='size-4 me-1'/> Link Course
                    </Button>}
                >
                    <FormPlaceholder/>
                </AppModal>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>List of all linked courses</CardDescription>
                </CardHeader>
                <CardContent>
